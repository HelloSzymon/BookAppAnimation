...
struct Home: View {
                ...
                HStack(spacing: 0) {
                    ForEach(sampleBooks) {
                        ...
                        VStack(alignment:.leading, spacing: 18) {
                            ...
                            //MARK: Sliding to the Current Index Position with Delay
    ...
    func BookSlider()-> some View {
        TabView(selection: $currentBook) {
            ForEach(sampleBooks) {
                book in BookView(book: book).tag(book)
            }
        }
    ...
    func BookView(book: Book)-> some View {
        ...
        //MARK: Rotation angle
            ...
            ZStack {
                ...
                .shadow(color: .black.opacity(0.12), radius: 6, x: -10, y: -8)
